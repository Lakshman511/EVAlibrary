...
class Net(nn.Module):
    ...
    def gotrain(self, optimizer, train_loader, test_loader, epochs, statspath,statsmanager, scheduler=None, batch_scheduler=False, L1lambda=0):
      self.trainer = ModelTrainer(statsmanager,self, optimizer, train_loader, test_loader, statspath, scheduler, batch_scheduler, L1lambda)
